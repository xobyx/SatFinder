...
//c
void
Java_com_xobyx_satfinder_MainActivity_SendLNBConfig(JNIEnv* env,
	jobject thiz)
{
...
void
Java_com_xobyx_satfinder_MainActivity_SendSelectedSatTp(JNIEnv* env, jobject thiz)
{
...
char _F[7] = { '\0' };
void Java_com_xobyx_satfinder_MainActivity_ProgressRecivedMessage(JNIEnv* env, jobject thiz, jbyteArray array)
{
...
void Java_com_xobyx_satfinder_MainActivity_SendPluse(JNIEnv *env, jobject thiz)//d
{
...
void  Java_com_xobyx_satfinder_MainActivity_SendSelectedSatTpLNBConfig(JNIEnv *env, jobject thiz)
{
...
void  Java_com_xobyx_satfinder_FieldStrengthFragment_SendCurrentTp(JNIEnv *env, jobject thiz, jint index)
{
