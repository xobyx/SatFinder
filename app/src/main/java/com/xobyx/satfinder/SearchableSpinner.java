...
public class SearchableSpinner extends AppCompatSpinner implements View.OnTouchListener,
        SearchableListDialog.SearchableItem, Serializable, Parcelable {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (null != _arrayAdapter) {
                ...
                _searchableListDialog.showNow(scanForActivity(_context).getSupportFragmentManager(), "TAG");
            }
        }
        return true;
    }
    ...
    public void setBasicDialogAdapter(boolean c) {
        _searchableListDialog.setBaseAdapter(c);
    }
